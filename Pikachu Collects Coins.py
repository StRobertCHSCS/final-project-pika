"""
Name: Pikachu Collects Coins.py
Purpose: Make a 2D game by unsage of global and local variables, booleans and lists.
Author: Sara.Tadjamoli
Created: 25/06/2019
"""
...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
SCREEN_TITLE = "Pikachu Collects Coins"
...
class MyGame(arcade.Window):
   ...
   def setup(self):
       ...
       self.background = arcade.load_texture("images/pokemon.jpg")

       # Set up the player
       self.player_sprite = arcade.Sprite("images/pikachu1.png", 0.09)
   ...
   def on_draw(self):
       ...
       arcade.draw_texture_rectangle(SCREEN_WIDTH // 1.3, SCREEN_HEIGHT // 1,
                                     1880, 1880, self.background)
       ...
       if self.game_over:
           arcade.draw_text("Game Over", self.view_left + 240, self.view_bottom + 550, arcade.color.BLACK, 35)
   ...
   def on_key_release(self, key, modifiers):
       """
       Called when the user releases a key button.
       """
